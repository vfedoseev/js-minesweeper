...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameModel = __webpack_require__(2);
	var Controls = __webpack_require__(6);
	var Modal = __webpack_require__(27);
	var CellType = __webpack_require__(5).CellType;
	var Classes = __webpack_require__(5).Classes;
	var GameState = __webpack_require__(5).GameState;
	var Default = __webpack_require__(5).Default;
	var Results = __webpack_require__(29);
	var Timer = __webpack_require__(32);
	
	var fieldTemplate = __webpack_require__(33);
	/**
	...
	var Game = function () {
	    ...
	    _createClass(Game, [{
	        ...
	        key: '_renderField',
	        value: function _renderField(options) {
	        ...
	        key: '_onFieldLeftClick',
	        value: function _onFieldLeftClick(event) {
	            var targetCell = this._getClickedCell(event);
	        ...
	        key: '_onFieldRightClick',
	        value: function _onFieldRightClick(event) {
	            var targetCell = this._getClickedCell(event);
	        ...
	        value: function _onMouseDown(event) {
	            var targetCell = this._getClickedCell(event);
	            var currentCell = this._currentClick.cell;
	        ...
	        value: function _onMouseUp(event) {
	            var targetCell = this._getClickedCell(event);
	            var currentCell = this._currentClick.cell;
	            var twoButtonsDown = this._currentClick.left && this._currentClick.right;
	        ...
	        key: '_resetCurrentClick',
	        value: function _resetCurrentClick() {
	            this._currentClick = {};
	        }
	        /**
	        ...
	        key: '_checkFirstClick',
	        value: function _checkFirstClick() {
	            if (!this._firstClick) {
	        ...
	        key: '_getClickedCell',
	        value: function _getClickedCell(event) {
	        ...
	        key: '_onCellOpen',
	        value: function _onCellOpen(event) {
	            var cell = event.detail;
	            var cellType = cell.type;
	            var cellEl = this._fieldEl.rows[cell.row].cells[cell.column];
	        ...
	        key: '_onCellToggle',
	        value: function _onCellToggle(event) {
	            var cell = event.detail;
	            var cellEl = this._fieldEl.rows[cell.row].cells[cell.column];
	        ...
	        key: '_onCellHighlight',
	        value: function _onCellHighlight(event) {
	            var cell = event.detail;
	            var cellEl = this._fieldEl.rows[cell.row].cells[cell.column];
	        ...
	        key: '_onCellClearHighlight',
	        value: function _onCellClearHighlight(event) {
	            var cell = event.detail;
	            var cellEl = this._fieldEl.rows[cell.row].cells[cell.column];
	        ...
	        key: '_onGameStateChange',
	        value: function _onGameStateChange(event) {
	        ...
	        value: function _end(state) {
	            ...
	            var message = 'You ' + (isWin ? 'WIN' : 'LOSE');
	            var modal = new Modal({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FieldModel = __webpack_require__(4);
	var GameState = __webpack_require__(5).GameState;
	var CellType = __webpack_require__(5).CellType;
	...
	var GameModel = function (_Dispatcher) {
	    _inherits(GameModel, _Dispatcher);
	    ...
	    function GameModel(options) {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(GameModel).call(this, options));
	    }
	    ...
	    _createClass(GameModel, [{
	        ...
	        key: 'markCell',
	        value: function markCell(row, column) {
	        ...
	        key: 'openCell',
	        value: function openCell(row, column) {
	            var _this2 = this;
	
	            var cell = this._checkAndOpenCell(row, column);
	            ...
	            switch (cell.type) {
	                case CellType.EMPTY:
	                    //Cell is empty - open all neighbours cells
	                    var neighbours = this._field.getNeighbours(row, column);
	                    neighbours.forEach(function (neighbourCell) {
	                        //we don't have to check mine because empty neighbours are not mines
	                        var neighbourRow = neighbourCell.row;
	                        var neighbourColumn = neighbourCell.column;
	
	                        _this2.openCell(neighbourRow, neighbourColumn);
	                    });
	                    break;
	                case CellType.MINE:
	                    // Cell has mine - game is over
	                    this._openAll();
	        ...
	        key: 'highlightCell',
	        value: function highlightCell(row, column) {
	            var _this3 = this;
	
	            var cellType = this._field.getCellType(row, column);
	            var cellIsOpened = this._openedCells[row + DELIMITER + column];
	            if (!cellIsOpened && cellType > 0) {
	                return;
	            }
	            var neighbours = this._field.getNeighbours(row, column);
	            var markedNeighbours = neighbours.filter(function (neighbourCell) {
	                return _this3._markedCells[neighbourCell.row + DELIMITER + neighbourCell.column];
	            }).length;
	            ...
	            neighbours.forEach(function (neighbourCell) {
	                ...
	                var neighbourRow = neighbourCell.row;
	                var neighbourColumn = neighbourCell.column;
	                var neighbourIsOpened = _this3._openedCells[neighbourRow + DELIMITER + neighbourColumn];
	                var neighbourIsMarked = _this3._markedCells[neighbourRow + DELIMITER + neighbourColumn];
	
	                if (!neighbourIsOpened && !neighbourIsMarked) {
	                    _this3._highlightedCells[neighbourRow + DELIMITER + neighbourColumn] = true;
	                    _this3.dispatchEvent('cellHighlight', neighbourCell);
	                }
	            });
	        }
	        ...
	        key: 'openHighlighted',
	        value: function openHighlighted() {
	            for (var i = 0; i < this._field.rows; i++) {
	                for (var j = 0; j < this._field.columns; j++) {
	        ...
	        value: function clearHighlight() {
	            for (var i = 0; i < this._field.rows; i++) {
	                for (var j = 0; j < this._field.columns; j++) {
	                    ...
	                    var cell = this._field.getCell(i, j);
	        ...
	        key: '_checkAndOpenCell',
	        value: function _checkAndOpenCell(row, column, force) {
	            var cellOpened = this._openedCells[row + DELIMITER + column];
	            var cellMarked = this._markedCells[row + DELIMITER + column];
	
	            if (!cellOpened && !cellMarked || force) {
	                var cell = this._field.getCell(row, column);
	        ...
	        value: function _checkGameState() {
	            ...
	            var openedCells = Object.keys(this._openedCells).length;
	            var totalMines = this._field.mines;
	            var totalCells = this._field.rows * this._field.columns;
...
/***/ function(module, exports) {
	...
	var Dispatcher = function () {
	    ...
	    _createClass(Dispatcher, [{
	        ...
	        value: function addEventListener(type, handler, capture) {
	        ...
	        key: 'dispatchEvent',
	        value: function dispatchEvent(type, detail, options) {
	            options = options || {};
	    ...
	    _createClass(FieldModel, [{
	        ...
	        value: function generate() {
	            ...
	            while (placedMines < this.mines) {
	                var rowIndex = Math.floor(Math.random() * this.rows);
	                var columnIndex = Math.floor(Math.random() * this.columns);
	            ...
	            for (var _i = 0; _i < this.rows; _i++) {
	                for (var j = 0; j < this.columns; j++) {
	                    if (this.getCellType(_i, j) === CellType.MINE) {
	                        var mineNeighbours = this.getNeighbours(_i, j);
	
	                        mineNeighbours.forEach(function (cellObj) {
	                            if (cellObj.type !== CellType.MINE) {
	                                _this._field[cellObj.row][cellObj.column] = cellObj.type + 1;
	                            }
	                        });
	                    }
	                }
	        ...
	        key: 'getNeighbours',
	        value: function getNeighbours(row, column) {
	            var neighbours = [];
	            var minCol = Math.max(0, column - 1);
	            var maxCol = Math.min(this.columns - 1, column + 1);
	            var minRow = Math.max(0, row - 1);
	            var maxRow = Math.min(this.rows - 1, row + 1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var controlsTemplate = __webpack_require__(7);
	
	/**
	 * Class representing the control panel
	 */
	
	var Controls = function (_Dispatcher) {
	    _inherits(Controls, _Dispatcher);
	    ...
	    function Controls(options) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Controls).call(this, options));
	
	        _this._render();
	        _this._timer = options.timer;
	        _this._timerEl = _this._el.querySelector('[data-content="timer"]');
	        _this._addListeners();
	        return _this;
	    }
	    ...
	    _createClass(Controls, [{
	        ...
	        value: function _onChange(event) {
	            var optionsForm = event.target.closest('[name="options-form"]');
	        ...
	        value: function _validateOptions() {
	            ...
	            var maxMines = this._getMinesMaxRange(options.rows, options.columns);
	        ...
	        key: '_getMinesMaxRange',
	        value: function _getMinesMaxRange(rows, columns) {
	        ...
	        key: '_onTimerUpdate',
	        value: function _onTimerUpdate(event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"controls-col\">\r\n    <form name=\"options-form\">\r\n        <label for=\"rows\" class=\"controls-element\">\r\n            <span class=\"control-name\">Rows ("
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.options : depth0)) != null ? stack1.minRows : stack1), depth0))
	    + "-"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.options : depth0)) != null ? stack1.maxRows : stack1), depth0))
	    + ")</span>\r\n            <input type=\"number\" name=\"rows\" id=\"rows\" class=\"control-input\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.options : depth0)) != null ? stack1.rows : stack1), depth0))
	    + "\" min=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.options : depth0)) != null ? stack1.minRows : stack1), depth0))
	    + "\" max=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.options : depth0)) != null ? stack1.maxRows : stack1), depth0))
	    + "\">\r\n        </label>\r\n        <label for=\"columns\" class=\"controls-element\">\r\n            <span class=\"control-name\">Columns ("
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.options : depth0)) != null ? stack1.minCols : stack1), depth0))
	    + "-"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.options : depth0)) != null ? stack1.maxCols : stack1), depth0))
	    + ")</span>\r\n            <input type=\"number\" name=\"columns\" id=\"columns\" class=\"control-input\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.options : depth0)) != null ? stack1.cols : stack1), depth0))
	    + "\" min=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.options : depth0)) != null ? stack1.minCols : stack1), depth0))
	    + "\" max=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.options : depth0)) != null ? stack1.maxCols : stack1), depth0))
	    + "\">\r\n        </label>\r\n        <label for=\"mines\" class=\"controls-element\">\r\n            <span class=\"control-name\">Mines <span data-range = \"mines\">("
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.options : depth0)) != null ? stack1.minMines : stack1), depth0))
	    + "-"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.options : depth0)) != null ? stack1.maxMines : stack1), depth0))
	    + ")</span></span>\r\n            <input type=\"number\" name=\"mines\" id=\"mines\" class=\"control-input\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.options : depth0)) != null ? stack1.mines : stack1), depth0))
	    + "\" min=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.options : depth0)) != null ? stack1.minMines : stack1), depth0))
	    + "\" max=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.options : depth0)) != null ? stack1.maxMines : stack1), depth0))
	...
	var Modal = function () {
	    ...
	    _createClass(Modal, [{
	        ...
	        value: function _render() {
	            ...
	            setTimeout(function () {
	                _this._el.querySelector('.modal').classList.remove('js-modal-hidden');
	            }, 20);
	        ...
	        value: function _onCloseClick(event) {
	            var closeBtn = event.target.closest('[data-action="close"]');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"modal modal-overlay js-modal-hidden\">\r\n    <div class=\"modal-inner\">\r\n        <h3 class=\"modal-title\">"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var resultsTemplate = __webpack_require__(30);
	/**
	 * Object representing the storage interface
	 */
	var Results = function () {
	    var storageName = '_minesweeper_data_';
	    ...
	    function _getFromStorage() {
	        var results = window.localStorage.getItem(storageName);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timer = function (_Dispatcher) {
	    _inherits(Timer, _Dispatcher);
